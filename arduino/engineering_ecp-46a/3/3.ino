 ...
 * in arduino.json
    "buildPreferences": [
        [
            "build.extra_flags",
            "-DUSB_VID=0x9999 -DUSB_PID=0x9003 '-DUSB_MANUFACTURER=\"Helios\"' '-DUSB_PRODUCT=\"Helios ECR3\"'"
        ]
    ]
**/
...
const int AXIS_X_PIN = A0; // cool front
const int AXIS_Y_PIN = A1; // cool rear
const int AXIS_Z_PIN = A3; // cool drones
const int AXIS_RX_PIN = A6; // power drones
const int AXIS_RY_PIN = A7; // power cargo
const int AXIS_RZ_PIN = A8; // power rear
const int HAT_0_PIN = A2; //cool cargo
